...
public class FoodOrderControllerTest {
    ...
    public void should_return_payment_succeeded_response () {
        ...
        Mockito.when(foodOrderService.handlePayment(anyString(),anyString(),anyDouble()))
        ...
        CommonResponse commonResponse = foodOrderController.orderPayment("11223344", paymentDTO);
    ...
    public void should_return_sign_succeeded_response_when_user_send_order_sign_request () {
        ...
        Mockito.when(foodOrderService.handleSign(anyString(),anyString(),anyString()))
        ...
        CommonResponse commonResponse = foodOrderController.orderSign("11223344", orderSignDTO);
