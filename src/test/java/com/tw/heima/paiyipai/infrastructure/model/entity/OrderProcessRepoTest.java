...
public class OrderProcessRepoTest {
    ...
    public void should_find_all_order_data_when_prepare_insert () {
        OrderEntity entity = OrderEntity.builder().id(1).contractId("326118").storeName("KFC").paymentAmount(35.42).paymentStatus(1).signStatus(1).build();
        orderProcessRepo.save(entity);
        OrderEntity originOrder = orderProcessRepo.findByContractId("326118");

        assertThat(originOrder.getContractId()).isEqualTo("326118");
